...
import com.blaze.launcher.BlazeLauncher;
import com.blaze.launcher.BlazeLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        BlazeLauncherModelDelegate delegate = (BlazeLauncherModelDelegate) launcher.getModel().getModelDelegate();
