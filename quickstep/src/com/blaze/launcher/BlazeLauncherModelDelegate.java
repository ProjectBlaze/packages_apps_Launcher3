...
public class BlazeLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "BlazeLauncherModelDelegate";
    ...
    public BlazeLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
